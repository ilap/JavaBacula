 ...
 * @author ilap
 */
public class ScheduleManager extends BaculaObjectManager {
    private static ScheduleManager instance = null;
    
    private ScheduleManager(int state) {
        super(state);
    }
    ...
    public static ScheduleManager getInstance() {
        if (instance == null) {
            instance = new ScheduleManager(initState()); 
        } 
        return instance;
    }
    
    public BaculaObject createBaculaItem() {
        return createBaculaItem(BaculaConstants.SCHEDULE_TYPE);
    }    
}
